...
#			current_battle.set_cards_in_card_manager(selected_ally.hand.cards)
#	get:
...
func characters_place_cards_themselves(characters: Array[AbstractCharacter]) -> void:
	...
	var speed_dice_that_are_involved_in_combat: Array[AbstractSpeedDice] = []
	for character in independent_characters:
		var speed_dice_with_cards: Array[AbstractSpeedDice] = character.place_cards_themself()
		speed_dice_that_are_involved_in_combat.append_array(speed_dice_with_cards)
